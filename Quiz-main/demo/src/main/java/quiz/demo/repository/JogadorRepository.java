...
public interface JogadorRepository extends JpaRepository<Jogador, Long> {
       ...
       @Query("SELECT j.nome, SUM(j.pontuacaoTotal) AS TotalPontuacao, COUNT(qj.jogador.id) AS QuizCount " +
           "FROM Jogador j " +
           "INNER JOIN QuizJogado qj ON j.id = qj.jogador.id " +
           "GROUP BY j.nome")
    List<Object[]> findTotalPontuacaoAndQuizCount();
